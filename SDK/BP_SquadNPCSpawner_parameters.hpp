...
public:
	...
	uint8                                        Pad_3F2E[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3F32[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3F33[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FF_NPCOnePointSpawnInfo               K2Node_MakeStruct_F_NPCOnePointSpawnInfo;          // 0x220(0x98)(HasGetValueTypeHash)
	uint8                                        Pad_3F34[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
