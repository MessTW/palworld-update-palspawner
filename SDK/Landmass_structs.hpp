...
public:
	...
	uint8                                        Pad_2BA2[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2BAF[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2BC2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2BC4[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
