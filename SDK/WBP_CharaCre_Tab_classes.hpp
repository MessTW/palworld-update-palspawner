...
public:
	...
	class UWBP_PalCommonButton_C*                WBP_PalCommonButton;                               // 0x2A0(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	struct FDataTableRowHandle                   MsgId;                                             // 0x2B8(0x10)(Edit, BlueprintVisible, NoDestructor)
	enum class E_UICharacterMakeCategory         BindCategoryType;                                  // 0x2C8(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
