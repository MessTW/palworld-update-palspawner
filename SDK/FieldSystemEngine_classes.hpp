...
{
public:
	uint8                                        Pad_276D[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27BA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_27BC[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27EC[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_283B[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
