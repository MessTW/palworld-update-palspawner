...
public:
	...
	class UNamedSlot*                            NamedSlot_InnnerVerticalBox;                       // 0x298(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	struct FDataTableRowHandle                   TitleMsgID;                                        // 0x2A8(0x10)(Edit, BlueprintVisible, NoDestructor)
