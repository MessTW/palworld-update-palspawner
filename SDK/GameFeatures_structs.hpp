...
{
public:
	uint8                                        Pad_A7B[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A7C[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_A7D[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
