...
{
public:
	uint8                                        Pad_A3F[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_A46[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_A56[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_A67[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
