...
public:
	...
	uint8                                        Pad_19A4[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19D2[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19E1[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_19E4[0x77];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19EE[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A0B[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A3A[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
