...
public:
	...
	uint8                                        Pad_3C[0x50];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3D[0xD];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4F[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	float                                        InVal;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5D[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5E[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
