...
public:
	...
	uint8                                        Pad_AFF[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B04[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B39[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B3C[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
