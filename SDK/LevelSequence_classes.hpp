...
{
public:
	uint8                                        Pad_153E[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_159C[0x100];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15A4[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15B1[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
