...
public:
	...
	uint8                                        Pad_2B3[0x1AB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B4[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2C2[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D8[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2EA[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
