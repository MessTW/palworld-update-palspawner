...
public:
	...
	uint8                                        Pad_2AFA[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2AFE[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         ShouldGatherFromEditorOnlyData;                    // 0x38(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2B01[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2B02[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2B03[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
