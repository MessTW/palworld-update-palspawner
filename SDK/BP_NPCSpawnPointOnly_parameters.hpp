...
public:
	...
	uint8                                        Pad_498B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FF_NPCOnePointSpawnInfo               CallFunc_Get_Spawn_One_Info_OneInfo;               // 0xA0(0x98)(HasGetValueTypeHash)
	uint8                                        Pad_498C[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_498D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4996[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FF_NPCOnePointSpawnInfo               K2Node_MakeStruct_F_NPCOnePointSpawnInfo;          // 0x240(0x98)(HasGetValueTypeHash)
	uint8                                        Pad_4997[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
