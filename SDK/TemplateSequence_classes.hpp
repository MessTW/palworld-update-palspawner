...
public:
	...
	uint8                                        Pad_E53[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E57[0x7C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E5B[0x260];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E5D[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E73[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E76[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E78[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
