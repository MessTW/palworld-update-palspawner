...
public:
	...
	struct FPalUIActionBindData                  CallFunc_RegisterActionBinding_NotConcume_ReturnValue; // 0x30(0x18)(None)
	struct FPalUIActionBindData                  CallFunc_RegisterActionBinding_NotConcume_ReturnValue_1; // 0x48(0x18)(None)
	struct FPalUIActionBindData                  CallFunc_RegisterActionBinding_ReturnValue;        // 0x60(0x18)(None)
	struct FPalUIActionBindData                  CallFunc_RegisterActionBinding_ReturnValue_1;      // 0x78(0x18)(None)
};
...
public:
	...
	uint8                                        Pad_3F18[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
