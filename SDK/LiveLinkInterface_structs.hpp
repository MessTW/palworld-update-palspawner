...
{
public:
	uint8                                        Pad_7ED[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_804[0xB];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_814[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_83C[0x160];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
