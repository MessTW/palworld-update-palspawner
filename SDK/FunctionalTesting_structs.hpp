...
public:
	...
	uint8                                        Pad_2C91[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2C94[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2C97[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2C98[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
